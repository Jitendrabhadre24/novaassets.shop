...
export default function SignupPage() {
  ...
  useEffect(() => {
    if (user && !isUserLoading) {
      // Sync user to firestore if needed, then redirect
    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4 bg-background hero-gradient">
      <Card className="w-full max-w-md border-white/5 bg-card/50 backdrop-blur-xl rounded-[2rem] overflow-hidden">
        <CardHeader className="pt-12 pb-8 text-center">
          ...
          <h1 className="text-3xl font-black font-headline uppercase tracking-tighter">Create Account</h1>
          <p className="text-muted-foreground font-medium">Join NovaAssets and unlock premium content.</p>
        </CardHeader>
        <CardContent>
